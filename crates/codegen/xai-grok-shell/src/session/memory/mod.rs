...
pub use xai_grok_memory::{
    ...
    MemoryStorage, archive, assemble_prior_context, backend, chunker, dream, dream_lock,
    embed_missing_chunks, embedding, index, init_sqlite_vec, mmr, query_expansion, schema, search,
    session_recall, storage, text_utils, watcher,
};
